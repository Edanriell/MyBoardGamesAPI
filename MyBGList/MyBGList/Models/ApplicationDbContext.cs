...
namespace MyBGList.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApiUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // One To Many.
            // We select BoardGame, BoardGame has one Publisher, but publisher has many BoardGames
            // We than select Foreign key make id required
            /*            modelBuilder
                            .Entity<BoardGame>()
